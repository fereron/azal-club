                                    ...
                                    <td align="left" class="mobile-padding" style="padding:20px">
                                        ...
                                        <div>
                                            <h1 style='font-family: "Arvo", sans-serif; font-size: 42px;'>
                                                Приглашение в <br> Azal Virtual Airlines
                                            </h1><br>
                                            <br>
                                            <h2 style='font-family: "Arvo", sans-serif; font-size: 21px;'>
                                                Здравствуйте! </h2> <br/> <br/>
                                            <div class="padding" style="border-left:1px solid #e7e7e7;">
                                                Пользователь {{ Auth::user()->full_name }} пригласил вас вступить в
                                                группу {{ $group->name }} на сайте Azal Virtual Airlines. <br>
                                                Для того чтобы принять заявку в группу, пожалуйста пройдите регистрацию
                                                с данным эл. адресом по ссылке ниже.
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            <a class="button button-blue" href="{{ route('register') }}" target="_blank">Регистрация</a>
                        </center>
                    </td>
                </tr>
            </table>
